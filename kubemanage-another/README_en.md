...
Before starting, set the configuration file environment variable `KUBEMANAGE_CONFIG="configuration file location"`, or specify it with the `configFile` command-line flag. Configuration priority: default configuration < environment variable < command line
```
